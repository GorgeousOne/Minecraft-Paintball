...
public class LobbySetSpawnCommand extends ArgCommand {
	...
	protected void executeArgs(CommandSender sender, List<ArgValue> argValues, Set<String> usedFlags) {
		...
		lobby.setSpawnPos(player.getLocation());
		sender.sendMessage(String.format("Set lobby '%s' spawn point to %s", lobby.getName(), LocationUtil.humanBlockPos(lobby.getSpawnPos())));
	}
